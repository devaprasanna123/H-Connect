...
import HospitalRequests from "./pages/doctor/HospitalRequests";
      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/doctor/requests" element={<ProtectedRoute allowedRoles={["doctor"]}><HospitalRequests /></ProtectedRoute>} />
